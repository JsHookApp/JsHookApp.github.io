    ...
    <main class="home-main">
      ...
      <section class="hero">
        <div class="hero-content">
          ...
          <p class="hero-desc">Implementing Hook with Js on Android · Frida-based mobile injection framework</p>
      ...
      <footer class="home-footer">
        <div class="footer-inner">
          <p>Released under the GPL3 license.</p>
          <p class="copyright">Copyright © 2022-{{ new Date().getFullYear() }} JsHook Developer</p>
        </div>
